...
const Register = ({ classes, setNewUser }) => {
  ...
  return (<div className={classes.root}>
    <Paper className={classes.paper}>
      ...
      }} onCompleted={data => setOpenDialog(true)}>
          ...
          return (
            <form onSubmit={event => handleSubmit(event, createUser)} className={classes.form}>
              ...
              <Button
                ...
                color="secondary">{loading ? "Registering..." :"Register"}</Button>
              <Button
              color="primary"
              variant="outlined"
              onClick={() => setNewUser(false)}
              fullWidth>Previous user? Log in here</Button>
    ...
    <Dialog open={openDialog} disableBackdropClick={true} TransitionComponent={Transition}>
      <DialogTitle>
